...
class InfoMenuState(State):
    ...
    def create_portrait(self):
        ...
        render_text(surf, ['text'], [self.unit.name], ['pink'], (48, 80), Alignments.CENTER)
        self.info_graph.register((24, 80, 52, 24), self.unit.desc, 'all')
        class_obj = DB.classes.get(self.unit.klass)
        render_text(surf, ['text'], [class_obj.name], ['pink'], (8, 104))
        self.info_graph.register((8, 104, 72, 16), class_obj.desc, 'all')
        render_text(surf, ['text'], [str(self.unit.level)], ['pink'], (39, 120), Alignments.RIGHT)
        self.info_graph.register((8, 120, 30, 16), 'Level_desc', 'all')
        render_text(surf, ['text'], [str(self.unit.exp)], ['pink'], (63, 120), Alignments.RIGHT)
        self.info_graph.register((38, 120, 30, 16), 'Exp_desc', 'all')
        render_text(surf, ['text'], [str(self.unit.get_hp())], ['pink'], (39, 136), Alignments.RIGHT)
        self.info_graph.register((8, 136, 72, 16), 'HP_desc', 'all')
        max_hp = equations.parser.hitpoints(self.unit)
        render_text(surf, ['text'], [str(max_hp)], ['pink'], (63, 136), Alignments.RIGHT)
    ...
    def create_personal_data_surf(self, growths=False):
        ...
        for idx, stat_nid in enumerate(left_stats):
            ...
            # Name
            name = curr_stat.name
            render_text(surf, ['text'], [name], ['red'], (8, 16 * idx + 24))
        ...
        for idx, stat_nid in enumerate(right_stats):
            ...
            # Name
            name = curr_stat.name
            render_text(surf, ['text'], [name], ['red'], (72, 16 * idx + 24))
            base_value = self.unit.stats.get(stat_nid, 0)
            contribution = self.unit.stat_contribution(stat_nid)
            contribution['Base Value'] = base_value
            desc_text = curr_stat.desc
        ...
        for idx, stat in enumerate(other_stats):
            ...
            if stat == 'AID':
                if growths:
                    ...
                    render_text(surf, ['text'], [text_funcs.translate('HP')], ['red'], (72, 16 * true_idx + 24))
                    self.info_graph.register((96 + 72, 16 * true_idx + 24, 64, 16), 'HP_desc', state)
                else:
                    aid = equations.parser.rescue_aid(self.unit)
                    render_text(surf, ['text'], [str(aid)], ['pink'], (111, 16 * true_idx + 24), Alignments.RIGHT)
                    ...
                    render_text(surf, ['text'], [text_funcs.translate('Aid')], ['red'], (72, 16 * true_idx + 24))
                ...
                render_text(surf, ['text'], [mana], ['pink'], (111, 16 * true_idx + 24), Alignments.RIGHT)
                render_text(surf, ['text'], [text_funcs.translate('MANA')], ['red'], (72, 16 * true_idx + 24))
                ...
                render_text(surf, ['text'], [gge], ['pink'], (111, 16 * true_idx + 24), Alignments.RIGHT)
                render_text(surf, ['text'], [text_funcs.translate('GAUGE')], ['red'], (72, 16 * true_idx + 24))
                self.info_graph.register((96 + 72, 16 * true_idx + 24, 64, 16), 'GAUGE_desc', state)

            if DB.constants.value('lead'):
                render_text(surf, ['text'], [text_funcs.translate('Lead')], ['red'], (72, 120))
    ...
    def create_wexp_surf(self):
        ...
        for y in range(0, 32, 16):
            for x in range(0, 2):
                ...
                render_text(surf, ['text'], [weapon_rank.nid], ['pink'], pos, Alignments.CENTER)
    ...
    def create_equipment_surf(self):
        ...
        render_text(surf, ['text'], [text_funcs.translate('Atk')], ['red'], (22, top))
        self.info_graph.register((96 + 14, top, 64, 16), 'Atk_desc', 'equipment')  
  
        render_text(surf, ['text'], [text_funcs.translate('AS')], ['red'], (78, top))
        self.info_graph.register((96 + 78, top, 56, 16), 'AS_desc', 'equipment')

        render_text(surf, ['text'], [text_funcs.translate('Hit')], ['red'], (22, top + 16))
        self.info_graph.register((96 + 14, top + 16, 64, 16), 'Hit_desc', 'equipment')

        render_text(surf, ['text'], [text_funcs.translate('Avo')], ['red'], (78, top + 16))
        self.info_graph.register((96 + 78, top + 16, 56, 16), 'Avoid_desc', 'equipment')

        render_text(surf, ['text'], [text_funcs.translate('Crit')], ['red'], (22, top + 32))
        self.info_graph.register((96 + 14, top + 32, 56, 16), 'Crit_desc', 'equipment')

        render_text(surf, ['text'], [text_funcs.translate('C.Avo')], ['red'], (78, top + 32))
        self.info_graph.register((96 + 78, top + 32, 56, 16), 'Crit_Avoid_desc', 'equipment')
        ...
        crit_avo = str(combat_calcs.crit_avoid(self.unit, weapon))
        render_text(surf, ['text'], [dam], ['pink'], (71, top), Alignments.RIGHT)
        render_text(surf, ['text'], [attack_speed], ['pink'], (127, top), Alignments.RIGHT)
        render_text(surf, ['text'], [acc], ['pink'], (71, top + 16), Alignments.RIGHT)
        render_text(surf, ['text'], [avo], ['pink'], (127, top + 16), Alignments.RIGHT)
        render_text(surf, ['text'], [crt], ['pink'], (71, top + 32), Alignments.RIGHT)
        render_text(surf, ['text'], [crit_avo], ['pink'], (127, top + 32), Alignments.RIGHT)
    ...
    def create_notes_surf(self):
        ...
        if my_notes:
            ...
            for idx, note in enumerate(my_notes):
                ...
                render_text(menu_surf, ['text'], [category], ['red'], (10, total_height))
